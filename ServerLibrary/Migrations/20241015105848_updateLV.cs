...
{
    /// <inheritdoc />
    public partial class updateLV : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Vactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Vactions_VacationTypes_VacationTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CityTown", x => new { x.CitiesId, x.TownsId });
                    table.ForeignKey(
                        name: "FK_CityTown_Cities_CitiesId",
                        column: x => x.CitiesId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CityTown_Towns_TownsId",
                        column: x => x.TownsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vactions_VacationTypeId",
                table: "Vactions",
